...
#
# Generated by export_simulation on Fri Apr 23 09:27:57 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './add32bits.sh' script.

./add32bits.sh -reset_run
...
./add32bits.sh -noclean_files

For more information on the script, please type './add32bits.sh -help'.
