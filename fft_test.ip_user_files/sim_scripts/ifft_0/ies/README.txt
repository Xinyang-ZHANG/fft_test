...
#
# Generated by export_simulation on Fri Apr 23 08:39:15 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './ifft_0.sh' script.
...
./ifft_0.sh -noclean_files

For more information on the script, please type './ifft_0.sh -help'.
