...
#
# Generated by export_simulation on Fri Apr 21 08:06:05 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './ifft_f.sh' script.
...
./ifft_f.sh -noclean_files

For more information on the script, please type './ifft_f.sh -help'.
