...
#
# Generated by export_simulation on Fri Apr 21 08:03:47 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './xfft_f.sh' script.
...
./xfft_f.sh -noclean_files

For more information on the script, please type './xfft_f.sh -help'.
