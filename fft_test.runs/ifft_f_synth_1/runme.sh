...
HD_PWD='D:/BaiduNetdiskDownload/fft_test3/fft_test3/fft_test3.runs/ifft_f_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ifft_f.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ifft_f.tcl
